package org.sepy.fontreader.table
{
	...
	{
		private var _components:ArrayCollection = new ArrayCollection();		// GlyfCompositeComp ( ArrayList<GlyfCompositeComp> )
	    ...
	    {
	        var c:GlyfCompositeComp = GlyfCompositeComp(_components.getItemAt(_components.length - 1));
	        var gd:IGlyphDescription = _parentTable.getDescription(c.getGlyphIndex());
	        if (gd != null) 
	        {
	    ...
	    {
	        return  GlyfCompositeComp(_components.getItemAt(i)).getFirstIndex();
	    }
	    ...
	    {
	        return GlyfCompositeComp(_components.getItemAt(i));
	    }
	    ...
	    internal function getCompositeComp( i:int ):GlyfCompositeComp
	    {
	        ...
	        {
	            c = GlyfCompositeComp(_components.getItemAt(n));
	            var gd:IGlyphDescription = _parentTable.getDescription(c.getGlyphIndex());
	    ...
	    internal function getCompositeCompEndPt( i:int ):GlyfCompositeComp
	    {
	        ...
	        {
	            c = GlyfCompositeComp(_components.getItemAt(j));
	            var gd:IGlyphDescription = _parentTable.getDescription(c.getGlyphIndex());
